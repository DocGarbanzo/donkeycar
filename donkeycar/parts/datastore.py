...
class Tub(object):
    ...
    def __init__(self, path, inputs=None, types=None, user_meta=[]):
        ...
        if exists:
            ...
            msg = "The tub path {} you provided doesn't exist and you didnt " \
                  "pass any meta info (inputs & types) " \
                  "to create a new tub. Please check your tub path or provide " \
                  "meta info to create a new tub.".format(path)
